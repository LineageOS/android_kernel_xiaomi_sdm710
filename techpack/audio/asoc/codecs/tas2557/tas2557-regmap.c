...
static int __init tas2557_init(void)
{
    printk("%s: init tas2557 \n", __func__);
    return  i2c_add_driver(&tas2557_i2c_driver);
}

static void __init tas2557_exit(void)
{
    pr_err("%s: exit tas2557 \n", __func__);
    i2c_del_driver(&tas2557_i2c_driver);
}
module_init(tas2557_init);
module_exit(tas2557_exit);
